# this script uses python's sqlite3 database. It works with Python 2.7. You may get errors with Python 3.5
...
conn = sqlite3.connect('example.db') # creates connection to the database

c = conn.cursor() # creates cursor to manipulate the database
